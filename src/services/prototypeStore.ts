...
const sondages: Sondage[] = [
  {
    ...
    description:
      "Exprimez anonymement votre ressenti sur le climat de travail cette semaine.",
    ...
    option: [
      {
        id: "option-1",
        libelle: "Très positif",
        id_sondage: "sondage-1",
        ordre_affichage: 1,
      },
      {
        id: "option-2",
  ...
  },
  {
    ...
    description:
      "Votez pour le thème que vous voulez traiter au prochain atelier pratique.",
    ...
    option: [
      {
        id: "option-4",
        libelle: "Sécurité mobile",
        id_sondage: "sondage-2",
        ordre_affichage: 1,
      },
      {
        id: "option-5",
  ...
  },
  {
    ...
    description:
      "Exemple de sondage terminé pour consulter uniquement les résultats.",
...
const votes: Vote[] = [
  {
    ...
    id_sondage: "sondage-1",
    id_option: "option-1",
    jeton_anonyme: "anon-a",
  },
  {
    id: "vote-2",
    id_sondage: "sondage-1",
    id_option: "option-1",
    jeton_anonyme: "anon-b",
  },
  {
    id: "vote-3",
    id_sondage: "sondage-1",
    id_option: "option-2",
    jeton_anonyme: "anon-c",
  },
  {
    id: "vote-4",
    id_sondage: "sondage-2",
    id_option: "option-6",
    jeton_anonyme: "anon-d",
  },
  {
    id: "vote-5",
    id_sondage: "sondage-2",
    id_option: "option-5",
    jeton_anonyme: "anon-e",
  },
  {
    id: "vote-6",
    id_sondage: "sondage-3",
    id_option: "option-8",
    jeton_anonyme: "anon-f",
  },
];
...
export function addPrototypeVote(
  id_sondage: string,
  id_option: string,
...
export function hasPrototypeParticipation(
  id_utilisateur: string,
  id_sondage: string,
) {
  return participations.some(
    (item) =>
      item.id_utilisateur === id_utilisateur && item.id_sondage === id_sondage,
  );
}
